...
export function ConfirmDialog({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-md rounded-2xl border border-[#EBE8E3] bg-white dark:bg-gray-dark shadow-xl dark:border-white/15">
        ...
        <DialogFooter className="flex gap-3 pt-6">
          <button
            ...
            disabled={loading}
            className="flex-1 rounded-lg border border-[#EBE8E3] dark:border-white/15 bg-white dark:bg-white/5 px-4 py-2.5 text-sm font-semibold text-gray-700 dark:text-gray-300 shadow-xs hover:bg-gray-50 dark:hover:bg-white/10 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
          >
            {cancelText}
          </button>
          <button
            ...
            disabled={loading}
            className={`flex-1 rounded-lg px-4 py-2.5 text-sm font-semibold shadow-xs disabled:opacity-50 disabled:cursor-not-allowed ${config.confirmButton}`}
          >
            {loading ? (
